...
def seed_timeline(db: Session):
    timeline_seed_data = [
        {
            ...
            "start_end": "2011 - 2016",
            "sort_order": 1,
            "img_url": "https://res.cloudinary.com/df5mtvzkn/image/upload/v1784871406/Portfolio/TimeLine/cam-quang-primary-school-logo_vvsfl4.jpg",
            "img_public_id": "Portfolio/TimeLine/cam-quang-primary-school-logo_vvsfl4",
        },
        {
            ...
            "start_end": "2016 - 2020",
            "sort_order": 2,
            "img_url": "https://res.cloudinary.com/df5mtvzkn/image/upload/v1784871406/Portfolio/TimeLine/nguyen-huu-thai-secondary-school-logo_zrnqyp.jpg",
            "img_public_id": "Portfolio/TimeLine/nguyen-huu-thai-secondary-school-logo_zrnqyp",
        },
        {
            ...
            "start_end": "2020 - 2023",
            "sort_order": 3,
            "img_url": "https://res.cloudinary.com/df5mtvzkn/image/upload/v1784871406/Portfolio/TimeLine/cam-binh-high-school-logo_s6y2hl.png",
            "img_public_id": "Portfolio/TimeLine/cam-binh-high-school-logo_s6y2hl",
        },
        {
            ...
            "sort_order": 4,
            "img_url": "https://res.cloudinary.com/df5mtvzkn/image/upload/v1784871405/Portfolio/TimeLine/gs25-logo_fymimi.jpg",
            "img_public_id": "Portfolio/TimeLine/gs25-logo_fymimi",
        },
        {
            ...
            "sort_order": 5,
            "img_url": "https://res.cloudinary.com/df5mtvzkn/image/upload/v1784871406/Portfolio/TimeLine/binh-duong-university-logo_fzlsbc.jpg",
            "img_public_id": "Portfolio/TimeLine/binh-duong-university-logo_fzlsbc",
        }
    ]

    for tl in timeline_seed_data:
        db_tl = TimeLine(title = tl["title"], 
            organization= tl["organization"],
            desc= tl["desc"],
            start_end=tl["start_end"],
    ...
    print("✅ Dữ liệu hàm seed_timeline đã sẵn sàng!")
