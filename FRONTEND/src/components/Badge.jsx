...
export const InfoBadge = ({icon, content}) =>{
    return(
        <span className={clsx(" px-4 py-2 border-2 flex justify-start w-fit items-center gap-2 rounded-md ",
...
export const TechBadge = ({name, icon:Icon, website, styleClass}) => {
    return (
        ...
        >
            <div className={clsx(""
                ," flex items-center justify-start gap-4 rounded-lg w-fit min-w-32 border-2 p-2 duration-[250ms] hover:shadow-lg hover:shadow-primary hover:-translate-y-1"
