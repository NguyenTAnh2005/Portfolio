...
export default function Timeline(){
    ...
    else content = <TimelineContent data={data}/>
    return (
...
const TimelineContent = ({data}) =>{
    ...
    return(
        <div className={clsx(baseclass, baseTransition)}>
            <motion.div 
            ...
            <div className={clsx(' relative flex flex-col gap-16 ')}>
            ...
            className='p-4 mt-16'>
                <div className='flex flex-col gap-8'>
                    ...
                    <div className={clsx( 
                        "",' text-base lg:text-3xl font-serif italic mx-auto indent-6 max-w-5xl ',
                        )}>
